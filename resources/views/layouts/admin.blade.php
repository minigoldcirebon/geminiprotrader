        ...
        <div class="hidden lg:fixed lg:inset-y-0 lg:z-50 lg:flex lg:w-72 lg:flex-col">
            <div class="flex grow flex-col gap-y-5 overflow-y-auto bg-gradient-to-b from-blue-900 to-blue-800 px-6 pb-4">
                <div class="flex h-16 shrink-0 items-center">
                    <img class="h-8 w-auto" src="{{ asset('images/logo-white.svg') }}" alt="Gemini Pro Trader">
                            ...
                            <ul role="list" class="-mx-2 space-y-1">
                                ...
                                <li>
                                    <a href="{{ route('admin.webhook-dashboard.index') }}" 
                                       class="text-blue-200 hover:text-white hover:bg-blue-700 group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold {{ request()->routeIs('admin.webhook-dashboard.*') ? 'bg-blue-700 text-white' : '' }}">
                                        <svg class="h-6 w-6 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
